...
namespace Fap.AspNetCore.Infrastructure
{
    internal static class Error
    {
        ...
        {
            return new ArgumentException(Error.Format("", actualValue, HttpScheme, HttpsScheme), parameterName);
        }
        ...
        {
            return new ArgumentException(Error.Format("", actualValue), parameterName);
        }
        ...
        {
            return Error.Argument(parameterName,"", parameterName);
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("", minValue));
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("", maxValue));
        }
        ...
        internal static ArgumentException InvalidEnumArgument(string parameterName, int invalidValue, Type enumClass)
        {
            ...
            return new ArgumentException(Error.Format("", parameterName, invalidValue, enumClass.Name), parameterName);
