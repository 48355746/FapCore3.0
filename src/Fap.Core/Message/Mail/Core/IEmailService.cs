...
namespace Fap.Core.Message.Mail.Core
{
    ...
    {
        Task<List<MimeMessage>> RecieveEmailByImapAsync(List<string> readedUids, SearchQuery query = null);
        Task<List<MimeMessage>> RecieveEmailByPop3Async(List<string> readedUids);
