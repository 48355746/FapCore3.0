...
Menus.prototype.defaultMenuItems = ['file',  'extras', 'help'];
...
Menus.prototype.init = function()
{
	...
	{
		//this.addMenuItems(menu, ['new',  '-', 'save', 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print'], parent);
        this.addMenuItems(menu, ['new', '-', 'save', 'saveAs', '-', 'import', '-', 'pageSetup', 'print'], parent);
	})));
