...
Actions.prototype.init = function()
{
	...
	// File actions
    this.addAction('new...', function () { graph.removeCells(graph.getChildVertices(graph.getDefaultParent()));   });
	...
	this.put('about', new Action(mxResources.get('about') + ' 流程设计器...', function()
	{
		if (!showingAbout)
		{
