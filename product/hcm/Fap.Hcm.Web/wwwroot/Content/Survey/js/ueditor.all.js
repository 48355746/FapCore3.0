            ...
            if (container) {
                var useBodyAsViewport = ie && browser.version < 9,
                    html = ( ie && browser.version < 9 ? '' : '<!DOCTYPE html>') +
                        ...
                        'body{margin:8px;font-family:Microsoft YaHei;font-size:14px;}' +
                        //设置段落间距
                        'p{margin:5px 0;}'
...
UE.plugins['list'] = function () {
    ...
    me.setOpt( {
        ...
        listiconpath : 'http://bj.bcebos.com/listicon/',
        maxListLevel : -1//-1不限制
    } );
...
(function () {
    ...
    Popup.prototype = {
        ...
        showAnchorRect: function ( rect, hoz, adj ){
            ...
            if(this.editor){
                popEl.style.zIndex = this.editor.container.style.zIndex * 1 + 100;
