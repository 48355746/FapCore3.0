;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="label label-warning">过滤到</span> {0} 条从 {1}', // when not all of the options are visible due to the filter
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      if (size == '') {
          ...
          this.elements.select1.attr('size', size);
          this.elements.select2.attr('size', size);
      }
