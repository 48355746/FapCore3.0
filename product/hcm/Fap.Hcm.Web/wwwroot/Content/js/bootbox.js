...
(function (root, factory) {
    ...
    exports.dialog = function (options) {
        ...
        if (options.closeButton) {
            ...
            if (options.title) {
                dialog.find(".modal-header").find(".onpage-help-modal-buttons").append(closeButton);
            }
            //else {
        ...
        if (buttonStr.length) {
            if (options.footer) {
                ...
                dialog.find(".modal-header").find(".onpage-help-modal-buttons").prepend($(buttonStr));
            }
        }
        ...
        dialog.on("hidden.bs.modal", function (e) {
            ...
            if (e.target === this) {
                dialog.remove();
                //wyf 多个dialog的时候 不要去掉 body中的 modal-open class，否则没有滚动条了
                if($(".bootbox")&&$(".bootbox").length>0)
                {
                    $(options.container).addClass('modal-open');
                }
            }
        });
        ...
        */
        ...
        function setBodyHeight() {
            var mbody = dialog.find('.modal-dialog');
            var diff = parseInt(mbody.css('marginTop'));
            diff = diff * 2 + 140 + parseInt(diff / 2);
            if (!options.footer) {
                diff -= 60;
            }
