...
namespace Fap.Hcm.Service.Payroll
{
    ...
    public class PayrollService : IPayrollService
    {
        ...
        public PayrollService(IDbContext dataAccessor,  IFapApplicationContext applicationContext)
        {
        ...
        public void AddPayItem(string caseUid, string[] payItems)
        {
            ...
            var items= _dbContext.Columns("PayCenter").Where(f => f.ColProperty.EqualsWithIgnoreCase("3") || payItems.Contains(f.Fid));
        ...
        public IEnumerable<PayCaseItem> GetPayCaseItem(string caseUid)
        {
           ...
           var payItems = _dbContext.Columns("PayCenter").Where(c => c.IsDefaultCol != 1 && !c.ColProperty.Trim().EqualsWithIgnoreCase("3"))
